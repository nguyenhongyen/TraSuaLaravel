...
<div class="content-wrapper">
    ...
    @include('admin.content_header',['name'=>'Danh mục sản phẩm','key'=> 'Sản phẩm/Bánh'])
    <!-- /.content-header -->
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
              <a href="{{ route('banhngot.create') }}" class="btn btn-success float-right m-2">Add</a>
            </div>
         <div class="col-md-12">
                      ...
                      <td>
                          @switch($value->danhmuc)
                            ...
                            @case(7)
                                ...
                                @break
                             @case(8)
                                <span class="text-info">Snacks</span>
                                @break
                            @case(9)
                                <span class="text-info">Bánh flan</span>
                                @break
                              @default
                          ...
                          <div class="row">
                              <div class="col-md-3">
                                  <button class="btn btn-light" style="margin-right:50px;">
                                      <a href="{{  route('banhngot.edit',[$value->id])  }}">
                                    <i class="fas fa-edit"></i>
                                  </a>
                                  </button>
                              </div>
                              <div class="col-md-2">
                                <form method="POST" action="{{ route('banhngot.destroy',[$value ->id]) }}">
                                   @method('DELETE')
                                   @csrf
