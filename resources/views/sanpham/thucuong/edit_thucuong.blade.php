...
<div class="content-wrapper">
      @include('admin.content_header',['name'=>'Danh mục sản phẩm','key'=> 'Thêm sản phẩm'])
        ...
        <div class="row">
            ...
            <div class="col-md-12">
               ...
               <div class="col-md-4">
                ...
                <form method="POST" action="{{ route('thucuong.update',[$sanpham->id])}}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">Tên sản phẩm</label>
                        <input type="text" class="form-control" name="tensanpham" value="{{$sanpham->tensanpham}}"  onkeyup="ChangeToSlug();" id="slug">
                      </div>
                      <div class="form-group col-md-6">
