        ...
        <div class="row">
            ...
            <div class="col-md-12">
               ...
               <div class="col-md-4">
                ...
                <form method="POST" action="{{ route('thucuong.store') }}" enctype="multipart/form-data">
                    @csrf
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">Tên sản phẩm</label>
                        <input type="text" class="form-control" name="tensanpham" value="{{old('tensanpham')}}"  onkeyup="ChangeToSlug();" id="slug">
                      </div>
                      <div class="form-group col-md-6">
