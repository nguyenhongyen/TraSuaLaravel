...
<div class="content-wrapper">
    ...
    @include('admin.content_header',['name'=>'Quản lý bình luận','key'=> 'Bánh'])
    <!-- /.content-header -->
                ...
                <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $value->banh->tenbanh}}</td>
                      <td><img src="{{ asset('public/uploads/anh/'.$value->banh->hinhanh) }}" height="120" weight="100"></td>
                      <td>{{ $value->noidung }}</td>
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-2">
                                <form method="POST" action="{{ route('thucuong.destroy',[$value ->id]) }}">
                                   @method('DELETE')
                                   @csrf
                                  <button class="btn btn-light" onclick="return confirm('Bạn có muốn xóa bình luận này không?')">
