        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('TraAnh/Thucuong') }}">{{ $banh->danhmucsp->tendanhmuc }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ $banh->tenbanh }}</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="container">
            <div class="row pb-4">
                ...
                <div class="col-md-6 product">
                    ...
                    <p>{{ $banh->mota }}</p>
                    @if($banh->giamgia != 0)
                    <span class="proOfPirce" style="font-size:18px;"><del>{{number_format($banh->giaban)}}đ</del></span>
                ...
                @endif
                <p><a onclick="AddCart({{ $banh->id }})" href="javascript:" title="Đặt Hàng"  class="btn btn-outline-success  btn-lg">Đặt hàng</a></p>
    ...
    <div class="container">
        <div class="comment">
            ...
            @if(Auth::guard('thanhvien')->check())
                    ...
                    @endif
                <form action="{{ url('nhan-xet-banh/'.$banh->id) }}" method="POST" >
                    @csrf
                        ...
                        <div class="shadow-none p-3 mb-3 bg-light rounded ">
                            ...
                            <div class="thumbnail">
                                ...
                                <div class="caption text-center">
                                    ...
                                    <div class="proPrice">
                                        @if($value->giamgia != 0)
                                        <span class="proOfPirce" style="font-size:18px;"><del>{{number_format($value->giaban)}}đ</del></span>
                                        <span class="proOfPirceSale" style="color: #21a321;
                                                                            font-weight: 30px;
                                                                            font-family: revert;
                                                                            font-weight: 500;">
