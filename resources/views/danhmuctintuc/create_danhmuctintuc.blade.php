...
<div class="content-wrapper">
      @include('admin.content_header',['name'=>'Danh mục tin tức','key'=> 'Thêm danh mục'])
        ...
        <div class="row">
            ...
            <div class="col-md-12">
               ...
               <div class="col-md-4">
                ...
                <form method="POST" action="{{ route('danhmuctintuc.store') }}">
                    @csrf
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">Tên danh mục</label>
                        <input type="text" class="form-control" name="tendanhmuc" value="{{old('tendanhmuc')}}"  onkeyup="ChangeToSlug();" id="slug" required>
                      </div>
                      <div class="form-group col-md-6">
